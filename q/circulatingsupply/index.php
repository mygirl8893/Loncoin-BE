...
$ch = curl_init('http://beta.ultranote.org:31000/json_rpc');
...
$ch2 = curl_init('http://beta.ultranote.org:31000/json_rpc');
...
curl_setopt($ch3, CURLOPT_URL, 'http://beta.ultranote.org:31000/getinfo');
